  ...
  return (
    <main className="min-h-screen bg-background text-textMain">
      <div className="grid min-h-screen lg:grid-cols-[1.08fr_0.92fr]">
        <section className="order-2 flex items-center justify-center p-6 lg:order-1 xl:p-14">
          <motion.div
        ...
        <section className="relative order-1 flex flex-col justify-between border-b-2 border-black bg-black p-6 text-white lg:order-2 lg:border-b-0 lg:border-l-2 lg:p-10 xl:p-14">
          <div className="absolute inset-0 brutalist-grid opacity-30" />

          <div className="relative z-10 space-y-10">
            <div className="flex items-center justify-between gap-4 border-2 border-white bg-black px-4 py-3">
              <Link href="/" className="font-anton text-xl sm:text-2xl uppercase tracking-[0.08em] text-white">
                Pantry Guardian
              </Link>
