      ...
      <div className="bg-black text-white p-8 border-4 border-black shadow-[10px_10px_0_#93E1A8]">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-[#93E1A8] border-2 border-black text-black font-black py-4 hover:translate-x-1 hover:-translate-y-1 transition-all flex items-center justify-center gap-3"
          >
